...
from models import TGATClassifier  # Adjust if your path differs
...
def main():
    ...
    parser.add_argument('--model_type', type=str, choices=['GCN', 'GIN'], default='GAT')
    ...
    for bus_name in ['pems04']:
        ...
        num_tep_graph=len(dataset)
        graphs_label=[dataset[i][-1].y for i in range(num_tep_graph)]
