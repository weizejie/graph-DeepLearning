### Implementation from https://github.com/benedekrozemberczki/pytorch_geometric_temporal/blob/master/torch_geometric_temporal/nn/recurrent/evolvegcnh.py
...
from evolvegcno import GCNConv_Fixed_W
...
class EvolveGCNH(torch.nn.Module):
    ...
    def forward(
        ...
        W = self.weight[None, :, :]
        X_tilde, W = self.recurrent_layer(X_tilde.broadcast_to(W.shape), W)
